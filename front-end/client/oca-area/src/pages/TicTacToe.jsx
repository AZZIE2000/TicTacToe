                    ...
                    <div className='flex gap-x-3 mr-3'>
                        <>
                            ...
                            <div className='flex gap-x-2 text-green-600' >
                                <BiXCircle className='  place-self-center h-5 w-5 md:h-9 md:w-9 ' />
                                <p className='place-self-center  text-1xl md:text-2xl font-bold' >{score?.x}</p>
                            </div>
                            <div className=' text-red-700 flex gap-x-2'>

                                <BiCircle className=' place-self-center h-5 w-5 md:h-9 md:w-9' />
                                <p className='place-self-center text-1xl md:text-2xl font-bold' >{score?.o}</p>
                            </div>
                        </>
                    </div>
                </div>
